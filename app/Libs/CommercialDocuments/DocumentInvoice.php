...
use App\Traits\InvoiceHelpers;
use App\Traits\TaxesFormatter;
...
class DocumentInvoice
{
     ...
     */
    public function __construct($document_name = '')
    {
        // Invoice
        ...
        // Filename
        $this->filename($this->getDefaultFilename($this->document_name));
     ...
     * @throws BindingResolutionException
     */
    public static function make($documentName = '')
    {
    ...
    /**
     * @return DocumentInvoiceItem
     */
    public static function makeItem(string $title = '')
    {
        return (new DocumentInvoiceItem)->title($title);
    }

    /**
     * @return $this
     */
    public function addItem(DocumentInvoiceItem $item)
    {
